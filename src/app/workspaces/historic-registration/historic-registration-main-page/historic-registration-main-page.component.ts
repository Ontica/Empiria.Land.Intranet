...
@Component({
  selector: 'emp-land-historic-registration-main-page',
  templateUrl: './historic-registration-main-page.component.html'
})
export class HistoricRegistrationMainPageComponent {
